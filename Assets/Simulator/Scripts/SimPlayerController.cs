...
public class SimPlayerController : MonoBehaviour {
    ...
    [SerializeField]
    private float moveSpeed = .00000001f;
	...
	private void Update () {
        ...
        //float chorizontal = Input.GetAxis("cHorizontal");
        //float cvertical = Input.GetAxis("cVertical");

        rigidbody.velocity = new Vector3(horizontal * 3, vertical * 3, 0);
        //rigidbody.velocity = new Vector3(chorizontal * 3, cvertical * 3, 0);
